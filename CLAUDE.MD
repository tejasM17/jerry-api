...
## Must :
- read `Architecture-Backend-API.md`
...
- Added new streaming endpoint `routes/stream.routes.js` and controller `controllers/stream.controller.js` for dedicated LLM streaming.
